...
const UserPage = () => {
  ...
  const handleGeneratePDF = () => {
    ...
    pdfDoc.text('User Profile Report', 20, 20);

    pdfDoc.text(`Username: ${editedUserData.username}`, 20, 40);
    pdfDoc.text(`Email: ${editedUserData.email}`, 20, 50);
    pdfDoc.text(`Profession: ${editedUserData.profession}`, 20, 60);

    pdfDoc.save('UserProfileReport.pdf');
  };
              ...
              <Card.Body>
                ...
                {editMode ? (
                  <>
                    ...
                    <Button variant="primary" onClick={handleGeneratePDF}>Создать PDF</Button>
                  </>
                ) : (
